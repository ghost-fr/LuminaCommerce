...
/// <summary>
/// Phase 1-5 scope. This context is the single write-model root per the
/// blueprint's infrastructure layer, not one context per module.
///
/// NOTE — this file replaces the Phase 1-4 version at the same path. Adds
/// QuoteRecords/InvoiceRecords on top of everything already there.
/// </summary>
