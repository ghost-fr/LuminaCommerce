...
/// roots (App.axaml.cs).
///
/// NOTE — this file replaces the Phase 8 version. Adds, as part of the
/// correctness-hardening pass: NumberSequenceGenerator (atomic ticket/invoice
/// numbering, replacing the old count-rows approach) and IUnitOfWork (real
/// transaction control, used by PosSaleService to close the stock-
/// availability race). Both registered Scoped, sharing the same DbContext as
